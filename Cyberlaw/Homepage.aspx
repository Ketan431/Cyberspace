<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="Cyberlaw.Homepage" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
                <div class="container">
                    <a class="navbar-brand js-scroll-trigger" href="#page-top">Cyber Security Portal</a>
            ...
            <header class="masthead" style="background-image: url('img/bg1.jpg');">
                <div class="container">
                    <div class="intro-text">
                        ...
                        <div class="intro-heading text-uppercase">We are happy to help you</div>
